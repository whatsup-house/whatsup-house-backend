    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/gatherings").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/api/gatherings/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PATCH, "/api/gatherings/**").hasRole("ADMIN")
