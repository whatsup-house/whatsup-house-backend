...
class AdminUserServiceTest {
    ...
    void listUsers_blankSearchPassedThrough() {
        Page<UserApplicationStatsRow> rawPage = new PageImpl<>(
                Collections.singletonList(new UserApplicationStatsRow(user, 3L, 2L)),
    ...
    void listUsers_returnsPageResponse() {
        Page<UserApplicationStatsRow> rawPage = new PageImpl<>(
                Collections.singletonList(new UserApplicationStatsRow(user, 5L, 1L)),
                PageRequest.of(0, 20), 1);
